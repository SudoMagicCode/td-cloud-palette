...
There are several repos available on github that contain collections that can be easily added to Cloud Palette. Here you can find a catalog of [Cloud Palette Compatible Repos](https://github.com/SudoMagicCode/cloud-palette-repos).
